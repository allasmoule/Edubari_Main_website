...
const statusStyles = {
    ...
    warning: "bg-rose-50 text-rose-600 border-rose-200/60",
};

/* ── Quick Actions ── */
const quickActions = [
    { label: "Add User", icon: FiPlus, color: "text-tertiary", bg: "bg-tertiary/8 hover:bg-tertiary/14 border-tertiary/10", path: "/admin/dashboard/create-user" },
    { label: "New Post", icon: FiEdit3, color: "text-emerald-600", bg: "bg-emerald-50 hover:bg-emerald-100/80 border-emerald-200/40", path: "/admin/dashboard/blogs" },
    { label: "Send Mail", icon: FiSend, color: "text-amber-600", bg: "bg-amber-50 hover:bg-amber-100/80 border-amber-200/40", path: "/admin/dashboard/messages" },
    { label: "View Reports", icon: FiEye, color: "text-rose-600", bg: "bg-rose-50 hover:bg-rose-100/80 border-rose-200/40", path: "/admin/dashboard/subscriptions" },
];
        ...
        <div className="space-y-6 animate-[fadeInUp_0.4s_ease-out]">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-5">
                ...
                <div className="xl:col-span-2 rounded-2xl border border-white/40 bg-white/70 backdrop-blur-sm p-5 sm:p-6 shadow-lg shadow-dark/[0.03]">
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <button type="button" className="p-2 rounded-lg text-dark/30 hover:text-dark/60 hover:bg-dark/5 transition-all duration-200 cursor-pointer border-none bg-transparent">
                        ...
                        {revenueData.map((d) => (
                            ...
                            >
                                <div className="w-full relative group/bar">
                                    ...
                                    <div
                                        className="w-full rounded-t-lg bg-gradient-to-t from-tertiary/80 to-[#8B5CF6]/60 hover:from-tertiary hover:to-[#8B5CF6] transition-all duration-300 cursor-pointer"
                ...
                <div className="rounded-2xl border border-white/40 bg-white/70 backdrop-blur-sm p-5 sm:p-6 shadow-lg shadow-dark/[0.03]">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        {quickActions.map((a) => (
                            <Link
                                key={a.label}
                                href={a.path}
                                className={`flex flex-col items-center gap-2.5 p-4 rounded-xl border ${a.bg} transition-all duration-200 cursor-pointer hover:-translate-y-0.5 no-underline`}
                            >
                    ...
                    {/* Mini Stats */}
                    <div className="mt-5 p-4 rounded-xl bg-gradient-to-br from-tertiary/8 to-[#8B5CF6]/5 border border-tertiary/10">
            ...
            <div className="rounded-2xl border border-white/40 bg-white/70 backdrop-blur-sm p-5 sm:p-6 shadow-lg shadow-dark/[0.03]">
                <div className="flex items-center justify-between mb-5">
                    ...
                    <Link href="/admin/dashboard/subscriptions" className="text-xs font-bold text-tertiary hover:text-tertiary-dark flex items-center gap-1 transition-colors duration-200 cursor-pointer no-underline">
                                ...
                                >
                                    <td className="py-3.5 pl-1">
                                        <div className="flex items-center gap-3">
                                            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-tertiary/20 to-[#8B5CF6]/15 flex items-center justify-center">
                ...
                <div className="sm:hidden space-y-3">
                    {activities.map((a) => (
                        ...
                        >
                            <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-tertiary/20 to-[#8B5CF6]/15 flex items-center justify-center shrink-0">
                                <span className="text-xs font-bold text-tertiary">
                                    {a.avatar}
                                </span>
                            </div>
