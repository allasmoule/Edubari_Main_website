          ...
          <div className="mt-12 lg:mt-14 grid gap-6 xl:grid-cols-[1.05fr_1.4fr] items-stretch">
            ...
            <div className="relative rounded-[28px] border border-white/20 bg-white/40 backdrop-blur-sm p-6 sm:p-8 shadow-sm overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <button
                  className="mt-8 inline-flex items-center gap-2 rounded-full bg-secondary hover:bg-secondary-light px-6 py-3 text-sm font-bold text-white shadow-md shadow-secondary/30 hover:shadow-lg hover:shadow-secondary/40 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300 cursor-pointer"
