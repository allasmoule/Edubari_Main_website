        ...
        <div className="px-6 sm:px-8 md:px-10 lg:px-12 py-12 sm:py-14">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mt-5 text-sm sm:text-[15px] lg:text-base leading-7 text-dark/70 max-w-2xl mx-auto">
              EduBari is a complete digital management platform built for
              educational institutions in Bangladesh — helping teachers, schools,
              and coaching centers run smarter every day.
            </p>
          </div>
          ...
          <div className="mt-12 lg:mt-14 grid gap-8 lg:grid-cols-2 max-w-5xl mx-auto items-start">
            ...
            <div className="space-y-5 text-sm sm:text-[15px] leading-7 text-dark/70">
              <p>
                We started with a simple observation: thousands of dedicated
                educators across Bangladesh were still relying on paper
                registers, scattered WhatsApp groups, and manual fee tracking.
              </p>
              <p>
                EduBari was built to solve that. We give every institution its
                own branded website, a complete management dashboard, and tools
                for attendance, exams, results, and fee collection — all set up
                within 24 hours.
              </p>
              <p>
                Today, we proudly serve{" "}
                <span className="font-bold text-dark">50+ institutions</span> and{" "}
                <span className="font-bold text-dark">5,000+ students</span>,
                with a team that believes great technology should be accessible
                to everyone.
              </p>
            </div>
