...
const navItems = [
  ...
  { path: "/admin/dashboard/billing", label: "Tenant Billing", icon: FiLayers },
  ...
  {
    path: "/admin/dashboard/ai-purchases",
    label: "AI Purchases",
    icon: FiBriefcase,
  },
  ...
  {
    path: "/admin/dashboard/feature-videos",
    label: "Demo Video Add",
    icon: FiImage,
  },
  {
    path: "/admin/dashboard/collected-leads",
    label: "Collect lead",
    icon: FiUsers,
  },
  ...
  const sidebarContent = (isMobile = false) => {
    ...
    return (
      <div className="flex flex-col h-full bg-white select-none">
        ...
        {/* Divider */}
        <div className={`mx-${isExpanded ? "5" : "3"} h-[1px] bg-dark/8`} />
        ...
        {/* Divider */}
        <div className={`mx-${isExpanded ? "5" : "3"} h-[1px] bg-dark/8 mt-3`} />
          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                ...
                className={`group relative flex items-center ${isExpanded ? "gap-3 px-4 py-3" : "justify-center px-0 py-3"} rounded-xl text-sm font-medium transition-all duration-200 ${
                  isActive
        ...
        >
          <div
            className={`h-[1px] ${isExpanded ? "mx-2" : "mx-1"} bg-dark/8 mb-2`}
          />
          ...
          <button
            ...
            className={`group relative w-full flex items-center ${isExpanded ? "gap-3 px-4 py-3" : "justify-center py-3"} rounded-xl text-sm font-medium text-dark/55 hover:bg-red-50 hover:text-red-500 transition-all duration-200 cursor-pointer border-none bg-transparent text-left`}
          >
          ...
          {!isMobile && (
            <button
              ...
              className={`w-full flex items-center ${isExpanded ? "gap-3 px-4" : "justify-center"} py-2.5 rounded-xl text-xs font-semibold text-dark/35 hover:text-dark/55 hover:bg-dark/[0.04] transition-all duration-200 cursor-pointer border-none bg-transparent`}
            >
              {collapsed ? (
