...
const WorkProofGrid = ({ activeCategory = "All" }) => {
    ...
    <section className="w-full px-4 sm:px-6 md:px-12 pb-10 sm:pb-14">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
        {loading ? (
          ...
          <div className="col-span-full text-center py-10 rounded-xl bg-red-50 border border-red-200/70">
            <p className="text-red-600 font-semibold">Failed to load work proofs</p>
              ...
              >
                ...
                <div className="p-6 flex flex-col grow">
                  <p className="text-xs font-bold text-tertiary tracking-wide uppercase mb-2">
                    {site.client_name || "School Portal"}
                  </p>
                  ...
                  <div className="mt-auto space-y-2 mb-6">
                    {(Array.isArray(site.features) ? site.features : ["Student Registration", "Marks Management", "Custom Domain"]).map(
                      (feature, idx) => (
                        <div
                          key={idx}
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="mt-7 w-full block rounded-xl px-6 py-3 text-sm font-bold text-center transition-all duration-300 hover:-translate-y-0.5 active:translate-y-0 bg-white/60 text-dark border border-dark/10 group-hover:bg-white/90 shadow-sm group-hover:shadow-md cursor-pointer"
                  >
                    Visit Live Site
                  </a>
                </div>
      ...
      {!loading && !error && filtered.length === 0 && (
        <div className="text-center py-16 max-w-md mx-auto">
          ...
          <h3 className="text-xl font-bold text-dark mb-2">No projects found</h3>
