...
const OurClients = () => {
    ...
    return (
    <section className="w-full px-4 sm:px-6 md:px-12 py-6 sm:py-8 lg:py-10 bg-white overflow-hidden">
            ...
            >
                ...
                >
                    {cards.map((client, index) => (
                        ...
                        >
                            <div className="bg-white border border-slate-100 rounded-[24px] p-6 shadow-lg shadow-slate-200/50 hover:shadow-2xl hover:shadow-slate-300 transition-all duration-500 flex flex-col items-center text-center group/card hover:-translate-y-1">
