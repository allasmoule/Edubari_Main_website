...
const WhyShouldChoose = () => {
  ...
  return (
    <section className="w-full px-4 sm:px-6 md:px-12 py-4 sm:py-6 lg:py-8 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch max-w-5xl mx-auto">
                ...
                <div className="lg:col-span-5 relative group">
                    <div className="h-full rounded-[32px] bg-linear-to-br from-[#1E293B] to-[#0F172A] p-5 flex flex-col justify-between overflow-hidden shadow-[0_20px_50px_rgba(15,23,42,0.2)] relative group-hover:-translate-y-2 transition-all duration-500">
                        {/* Decorative background shape */}
                        <div className="absolute -bottom-20 -right-20 w-64 h-64 bg-[#3B42F2] rounded-full blur-[100px] opacity-20" />
                        
                        <div className="relative z-10">
                            <div className="h-10 w-10 rounded-xl bg-white/10 backdrop-blur-md flex items-center justify-center text-white mb-5 border border-white/10">
                                <FiCheckCircle className="h-5 w-5" />
                            </div>

                            <h3 className="text-lg sm:text-xl font-black text-white leading-tight mb-3">
                                More Than Just a Website — It’s Your <span className="text-[#3B42F2]">Brand</span>
                            </h3>

                            <p className="text-slate-400 font-medium text-[13px] leading-snug mb-5">
                            ...
                            <div className="space-y-1.5 mb-5">
                                {[
                                    ...
                                    <div key={item} className="flex items-center gap-3 text-slate-300 font-semibold text-[11px]">
                                        <div className="h-4 w-4 rounded-full bg-[#3B42F2]/20 flex items-center justify-center text-[#3B42F2]">
                        ...
                        <button
                            ...
                            className="relative z-10 w-full py-3 rounded-xl bg-[#3B42F2] text-white font-black text-[10px] hover:bg-blue-700 transition-all flex items-center justify-center gap-2 group/btn shadow-xl shadow-blue-500/20"
                        >
                            Start With EduBari
                ...
                <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                    {features.map((feature) => (
                        <div
                            key={feature.id}
                            className="group relative rounded-[32px] bg-white border border-slate-50 p-4 sm:p-5 transition-all duration-500 hover:-translate-y-2 shadow-[0_15px_40px_rgba(0,0,0,0.03)] hover:shadow-[0_25px_50px_rgba(59,66,242,0.08)]"
                        >
                            <div className={`h-10 w-10 rounded-xl flex items-center justify-center ${feature.accent} mb-4 transition-all duration-500 group-hover:rotate-6 shadow-sm`}>
                                <div className="text-[#3B42F2]">
                                    {feature.icon}
                                </div>
                            </div>

                            <h4 className="text-sm font-black text-[#1E293B] mb-1.5 group-hover:text-[#3B42F2] transition-colors duration-300">
                                {feature.title}
                            </h4>

                            <p className="text-[#64748B] font-semibold text-[10px] leading-snug">
                                {feature.description}
                            </p>
