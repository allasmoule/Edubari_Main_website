...
const WhyShouldChoose = () => {
  ...
  return (
    <section className="w-full px-4 sm:px-6 md:px-12 py-6 sm:py-8 lg:py-10 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-stretch max-w-6xl mx-auto">
                ...
                <div className="lg:col-span-5 relative group">
                    <div className="h-full rounded-[32px] bg-linear-to-br from-[#1E293B] to-[#0F172A] p-8 flex flex-col justify-between overflow-hidden shadow-[0_20px_50px_rgba(15,23,42,0.2)] relative group-hover:-translate-y-2 transition-all duration-500">
                        {/* Decorative background shape */}
                        <div className="absolute -bottom-20 -right-20 w-64 h-64 bg-[#3B42F2] rounded-full blur-[100px] opacity-20" />
                        
                        <div className="relative z-10">
                            <div className="h-14 w-14 rounded-xl bg-white/10 backdrop-blur-md flex items-center justify-center text-white mb-6 border border-white/10">
                            ...
                            <p className="text-slate-400 font-medium text-base leading-snug mb-6">
                            ...
                            <div className="space-y-3 mb-8">
                                {[
                                    ...
                                    <div key={item} className="flex items-center gap-3 text-slate-300 font-semibold text-sm">
                        ...
                        <button
                            ...
                            className="relative z-10 w-full py-3.5 rounded-xl bg-[#3B42F2] text-white font-black text-xs hover:bg-blue-700 transition-all flex items-center justify-center gap-2 group/btn shadow-xl shadow-blue-500/20"
                        >
                            Start With EduBari
                ...
                <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
                    {features.map((feature) => (
                        <div
                            key={feature.id}
                            className="group relative rounded-[32px] bg-white border border-slate-50 p-6 sm:p-8 transition-all duration-500 hover:-translate-y-2 shadow-[0_15px_40px_rgba(0,0,0,0.03)] hover:shadow-[0_25px_50px_rgba(59,66,242,0.08)]"
                        >
                            <div className={`h-12 w-12 rounded-xl flex items-center justify-center ${feature.accent} mb-5 transition-all duration-500 group-hover:rotate-6 shadow-sm`}>
                                <div className="text-[#3B42F2]">
                                    {feature.icon}
                                </div>
                            </div>

                            <h4 className="text-lg font-black text-[#1E293B] mb-3 group-hover:text-[#3B42F2] transition-colors duration-300">
                                {feature.title}
                            </h4>

                            <p className="text-[#64748B] font-semibold text-xs leading-snug">
                                {feature.description}
                            </p>
