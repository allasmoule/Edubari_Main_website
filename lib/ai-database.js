...
function getDefaultPackages() {
  return [
    { id: "pkg_starter", name: "Starter Pack", credits: 5, validityDays: 30, price: 99, currency: "BDT", isActive: true },
    { id: "pkg_pro", name: "Pro Pack", credits: 10, validityDays: 30, price: 179, currency: "BDT", isActive: true, highlight: true },
    { id: "pkg_unlimited", name: "Power Pack", credits: 20, validityDays: 30, price: 299, currency: "BDT", isActive: true },
  ];
}
