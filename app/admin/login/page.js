...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden px-4 py-10">
      {/* Background */}
      <div className="absolute inset-0 bg-linear-to-br from-primary via-primary-light to-white z-0" />
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(37,99,235,0.12),transparent_60%)] z-0" />
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,rgba(139,92,246,0.08),transparent_60%)] z-0" />

      {/* Decorative Blobs */}
      <div className="absolute top-[-120px] right-[-80px] w-[300px] h-[300px] bg-tertiary/10 rounded-full blur-3xl z-0 pointer-events-none" />
      <div className="absolute bottom-[-100px] left-[-60px] w-[250px] h-[250px] bg-[#8B5CF6]/10 rounded-full blur-3xl z-0 pointer-events-none" />

      {/* Card */}
      <div className="relative w-full max-w-[440px] animate-[fadeInUp_0.5s_ease-out] z-10">
        {/* Glow behind card */}
        <div className="absolute -inset-1 bg-linear-to-r from-tertiary/20 to-[#8B5CF6]/20 rounded-3xl blur-xl opacity-60 pointer-events-none" />
        ...
        <div className="relative rounded-2xl border border-white/40 bg-white/70 backdrop-blur-md p-8 sm:p-10 shadow-xl shadow-dark/5">
          ...
          <div className="text-center mb-8">
            <Link href="/" className="inline-block no-underline">
              <h1 className="text-3xl font-black tracking-tight text-dark select-none m-0">
                Edu
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-dark/30 hover:text-dark/60 transition-colors duration-200 cursor-pointer border-none bg-transparent"
                >
                  {showPassword ? (
          ...
          <div className="mt-6 text-center">
            <Link
              href="/"
              className="text-sm font-semibold text-dark/50 hover:text-dark/80 transition-colors duration-200 no-underline"
            >
              ← Back to Website
            </Link>
          </div>
